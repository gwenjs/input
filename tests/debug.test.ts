...
describe('InputDebugAPIImpl', () => {
  ...
  it('fires onActionTriggered callback', () => {
    ...
    let triggered = false
    debug.onActionTriggered(() => { triggered = true })
  ...
  it('fires onContextChanged callback', () => {
    ...
    let changed = false
    debug.onContextChanged(() => { changed = true })
  ...
  it('fires onBindingChanged callback', () => {
    ...
    let changed = false
    const unsubscribe = debug.onBindingChanged(() => { changed = true })
  ...
  it('fires onDeviceChanged callback', () => {
    ...
    let changed = false
    debug.onDeviceChanged(() => { changed = true })
  ...
  it('fires onRecordingStateChanged callback', () => {
    ...
    let changed = false
    debug.onRecordingStateChanged(() => { changed = true })
  ...
  it('unsubscribes from callbacks', () => {
    ...
    let frameCount = 0
    const unsubscribe = debug.onFrame(() => { frameCount++ })
  ...
  it('does not fire onContextChanged when contexts unchanged', () => {
    ...
    let changeCount = 0
    debug.onContextChanged(() => { changeCount++ })
